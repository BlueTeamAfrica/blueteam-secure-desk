...
const exportDocxLabels = {
  ...
  fieldReporterRegion: "Reporter region",
  fieldReporterPhone: "Reporter phone",
  fieldReporterAlias: "Reporter alias",
  fieldSource: "Source",
  fieldAssignedOwner: "Assigned owner",
...
export const factsdWorkspaceConfig: WorkspaceConfig = {
  ...
  notificationLabels: {
    ...
    assignedBody: "Case «{title}» has been assigned to you.",
    designedTitle: "Case published",
    designedBody: "Case «{title}» has been moved to the published stage.",
    emailSubjectAssigned: "Case assigned — {title}",
    emailSubjectDesigned: "Case published — {title}",
