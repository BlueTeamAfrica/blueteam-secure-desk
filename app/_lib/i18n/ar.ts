...
export const arLabels: Partial<OrgLabels> = {
  ...
  notificationLabels: {
    ...
    assignedBody: "تم إسنادك إلى «{title}».",
    designedTitle: "تم نشر الحالة",
    designedBody: "انتقلت «{title}» إلى مرحلة النشر.",
    emailSubjectAssigned: "تم إسناد تقرير — {title}",
    emailSubjectDesigned: "تم نشر التقرير — {title}",
